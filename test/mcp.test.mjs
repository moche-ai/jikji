...
test('MCP SDK 호환: initialize + tools/list + write→search 라운드트립', async () => {
  ...
  try {
    ...
    assert.deepEqual(names, ['memory_confirm', 'memory_export_md', 'memory_forget', 'memory_graph', 'memory_hygiene', 'memory_import_md', 'memory_invalidate', 'memory_lineage', 'memory_list', 'memory_pending', 'memory_pin', 'memory_review', 'memory_search', 'memory_update', 'memory_write', 'memory_write_batch']);
